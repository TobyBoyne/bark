...
parser.add_argument("-num-itr", type=int, default=30)
parser.add_argument("-rnd-seed", type=int, default=100)
...
for itr in range(args.num_itr):
    ...
    opt_model = build_opt_model(bb_func.get_space(), gbm_model, tree_gp, kappa=1.96)
...
ani.save("figs/bo_1d_animated.mp4")
plt.show()