...
from bark.fitting.bart.quick_inverse import QuickInverter

from ...forest import BARKTree, DecisionNode, LeafNode
...
def propose_transition(
    data: BARKData, tree: BARKTree, params: BARTTrainParams, rng: np.random.Generator
) -> "Transition":
...
class Transition(abc.ABC):
    ...
    def __init__(self, tree: BARKTree):
        self.tree = tree
    ...
    def log_likelihood_ratio(
        self, model: BARKGP, quick_inverter: QuickInverter
    ) -> float:
...
class GrowTransition(Transition):
    def __init__(self, tree: BARKTree, cur_node: LeafNode, new_node: DecisionNode):
