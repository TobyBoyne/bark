...
def noise_acceptance_probability(model: BARKGP, new_noise: float, prior: rv_frozen):
...
def scale_acceptance_probability(model: BARKGP, new_scale: float, prior: rv_frozen):
